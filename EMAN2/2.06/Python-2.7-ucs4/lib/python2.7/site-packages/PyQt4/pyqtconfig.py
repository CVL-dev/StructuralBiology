...
_pkg_config = {
    'pyqt_bin_dir':      '/home/eman64/Python/bin',
    'pyqt_config_args':  '--qmake=/home/eman64/library/qt-everywhere-opensource-src-4.7.3/bin/qmake',
    'pyqt_mod_dir':      '/home/eman64/Python/lib/python2.7/site-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtMultimedia QtNetwork QtDeclarative QtOpenGL QtScript QtScriptTools QtSql QtSvg QtTest QtWebKit QtXml QtXmlPatterns QtDesigner',
    'pyqt_sip_dir':      '/home/eman64/Python/share/sip/PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -t Qt_4_7_2 -x Py_v3 -g',
    'pyqt_version':      0x040805,
    'pyqt_version_str':  '4.8.5',
    'qt_data_dir':       '/home/eman64/library/qt-everywhere-opensource-src-4.7.3',
    'qt_dir':            '/home/eman64/library/qt-everywhere-opensource-src-4.7.3',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        '/home/eman64/library/qt-everywhere-opensource-src-4.7.3/include',
    'qt_lib_dir':        '/home/eman64/library/qt-everywhere-opensource-src-4.7.3/lib',
    'qt_threaded':       1,
    'qt_version':        0x040703,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR_QT':                '/home/eman64/library/qt-everywhere-opensource-src-4.7.3/include',
    ...
    'LIBDIR_QT':                '/home/eman64/library/qt-everywhere-opensource-src-4.7.3/lib',
    ...
    'MKDIR':                    'mkdir -p',
    'MOC':                      '/home/eman64/library/qt-everywhere-opensource-src-4.7.3/bin/moc',
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    'strip'
}
